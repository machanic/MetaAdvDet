...
def evaluate_cross_arch(args):
    ...
    with open("{}/train_pytorch_model/ROTATE_DET/cv2_rotate_model/cross_arch_{}--{}_using_{}_result.json".format(PY_ROOT, args.cross_arch_source,
                                                                            args.cross_arch_target, args.protocol), "w") as file_obj:
