...
import traditional_deep_learning.resnet_18.imagenet_input as data_input
import traditional_deep_learning.resnet_18.resnet as resnet

# Dataset Configuration
tf.app.flags.DEFINE_string('train_dataset', 'scripts/train_shuffle.txt',
                           """Path to the ILSVRC2012 the training dataset list file""")
tf.app.flags.DEFINE_string('train_image_root', '/home1/machen/dataset/CIFAR-10/split_data_mem/train',
                           """Path to the root of ILSVRC2012 training images""")
tf.app.flags.DEFINE_string('val_dataset', 'scripts/val.txt', """Path to the test dataset list file""")
tf.app.flags.DEFINE_string('val_image_root', '/home1/machen/dataset/CIFAR-10/split_data_mem/test',
                           """Path to the root of ILSVRC2012 test images""")
tf.app.flags.DEFINE_string('mean_path', './ResNet_mean_rgb.pkl', """Path to the imagenet mean""")
tf.app.flags.DEFINE_integer('num_classes', 15, """Number of classes in the dataset.""")
tf.app.flags.DEFINE_integer('num_train_instance', 684079, """Number of training images.""")
tf.app.flags.DEFINE_integer('num_val_instance', 12000, """Number of val images.""")
...
tf.app.flags.DEFINE_integer('gpu', 0, """GPU device ID.""")
...
def train():
    ...
    with tf.Graph().as_default():
        ...
        lr_decay_steps = map(int,
                             [s * FLAGS.num_train_instance / FLAGS.batch_size / FLAGS.num_gpus for s in lr_decay_steps])
