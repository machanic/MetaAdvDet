...
from traditional_deep_learning.pytorch.npy_dataset import NpzDataset
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    train_dataset = NpzDataset("/home1/machen/dataset/CIFAR-10/split_data_mem/",
                               "/home1/machen/dataset/CIFAR-10/split_data_mem/train_image_label.txt")

    val_dataset = NpzDataset("/home1/machen/dataset/CIFAR-10/split_data_mem/",
                              "/home1/machen/dataset/CIFAR-10/split_data_mem/test_image_label.txt")
    if args.distributed:
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if not args.multiprocessing_distributed or (args.multiprocessing_distributed
            ...
            }, is_best, filename="{}_traditional_dl_detect.pth.tar".format(args.arch))
